...
export const BLOGS: BlogPost[] = [
  {
    ...
    content: [
      ...
      { type: "img", src: "/blog/inside-dt-guide-1.jpg", alt: "Isometric smart city visual", caption: "A single visual language across web, tablet, and kiosk." },
...

  {
    ...
    cover: "/blog/cover-mobile-walkthrough.jpg",
    ...
    content: [
      ...
      { type: "img", src: "/blog/inside-mobile-1.jpg", alt: "Smartphone with 3D city", caption: "A compact UI still communicates scale and context." },
...

  {
    ...
    cover: "/blog/cover-sales-center.jpg",
...

  {
    ...
    cover: "/blog/cover-real-time-3d.jpg",
    ...
    content: [
      ...
      { type: "img", src: "/blog/inside-real-time-1.jpg", alt: "Developer screen with code", caption: "Profiling time varies by device—budget for it." },
...

  {
    ...
    cover: "/blog/cover-amenities.jpg",
    category: "Insights",
    ...
    content: [
      ...
      { type: "img", src: "/blog/inside-amenities-1.jpg", alt: "Modern residential towers", caption: "Design the amenity story around real-life routines." },
