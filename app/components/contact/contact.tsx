  ...
  export default function Contact() {
    ...
    async function onSubmit(e: React.FormEvent) {
      ...
      try {
        ...
        // TODO: wire up your own endpoint (e.g., /api/contact) or 3rd-party form service here.
        // demo: fake wait
  ...
  return (
    <section
      ...
      className="relative"
      style={{
        /* ⬇️ more space below the header */
      paddingTop: "calc(var(--header-h, 72px) + 96px)",   // was +24px
    ...
    >
        ...
        <div className="relative z-[1] mx-auto max-w-[1450px] px-6 pb-20">
          {/* Heading */}
          <motion.div
            variants={WRAP}
            initial="hidden"
          ...
          >
            ...
            <motion.h1
              variants={ITEM}
              className="typo-hero-light mt-2 text-transparent bg-clip-text bg-gradient-to-r from-white to-[#C6F24E] md:text-[72px]"
            >
              Contact Us
            </motion.h1>
              ...
              >
                ...
                <ul className="mt-5 space-y-4 text-white/80">
                  <li>
                    ...
                    <div className="typo-small-heading">hello@yourstudio.com</div>
                  </li>
                  <li>
                    <div className="text-sm">Phone</div>
                    <div className="typo-small-heading">+90 (000) 000 00 00</div>
                  </li>
                  <li>
